...
export const getUsers = catchAsync(async (req: Request, res: Response) => {
  ...
  const options: IOptions = pick(req.query, ['sortBy', 'limit', 'page', 'projectBy', 'current', 'pageSize']);
  options.limit = options.pageSize as any;
  options.current = options.page as any;
